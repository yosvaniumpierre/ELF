...
msbuild /t:BuildRelease /p:DeployOnBuild=True Build-Central.xml /l:FileLogger,Microsoft.Build.Engine;logfile=./Artifacts/BuildLog/build-codebase-release.log
pause